...
const translations: Record<Locale, TranslationDict> = {
	en: {
		...
		'profile.importError': 'Invalid file. Import failed.',
	...
	'pt-BR': {
		...
		'profile.importSuccess': 'Dados importados com sucesso.',
		'profile.importError': 'Arquivo inválido. Importação falhou.',
