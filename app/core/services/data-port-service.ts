...
const EXPORT_STORES = ['users', 'workout', 'exercise', 'execution', 'userWeightProgression', 'userStrike'] as const;

const UPSERT_STORES = ['users', 'execution', 'userWeightProgression', 'userStrike'] as const;
